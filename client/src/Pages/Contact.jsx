...
function Contact() {
  ...
  const hSubmission = async (e) => {
    ...
    try {
      const response = await fetch("https://techsphere-8ec2.onrender.com/contact", {
        method: "POST",
  ...
  return (
    ...
    <h3>Bullring Store</h3>

    <p><strong>Located in:</strong> Bullring</p>

    <p>
      <strong>Address:</strong> Bullring Shopping Centre Bullring, MSU5, SU330 & SU331, Birmingham B5 4BG
    </p>

    <p><strong>Phone:</strong> 0121 616 1136</p>

    <p><strong>Hours:</strong></p>
    <p className="hours">Closed · Opens 9 am Mon</p>
  </div>
    </div>
</div>    
  );
